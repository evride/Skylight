...
class Object3dView(QtWidgets.QOpenGLWidget):
    ...
    def paintGL(self):
        ...
        self.gl.glScale(self.scale, self.scale, self.scale)
    ...
    def resizeGL(self, width, height):
        ...
        self.gl.glLoadIdentity()
        #self.glu.gluPerspective(70, width/height, 1.0, 100)s
    ...
    def drawGrid(self, size, sections):
        ...
        self.gl.glVertex3d(-size/2, -size/2, -0.1)
        self.gl.glVertex3d(-size/2, size/2,  -0.1)
        self.gl.glVertex3d(size/2, size/2,  -0.1)
        self.gl.glVertex3d(size/2, -size/2,  -0.1)
        self.gl.glEnd()
        ...
        for i in range(0, sections+1):
            ...
            self.gl.glVertex3d(offset, -size/2, 0.05)
            self.gl.glVertex3d(offset, size/2, 0.05)
            self.gl.glVertex3d(-size/2, offset, 0.05)
            self.gl.glVertex3d(size/2, offset, 0.05)
